...
pub(crate) async fn get_message(log: FragmentNftFilter, meta: LogMeta) -> String {
...
pub(crate) async fn get_top_bid(collection: String, token_id: U256) -> String {
...
pub(crate) async fn get_valuation(collection: String, token_id: U256) -> String {
...
pub(crate) async fn slug(collection: &String) -> Option<String> {
